...
<body>
    <div class="container">
        <div class="header" style="margin-bottom: 30px;">
            <h2>Toko Habib Hammam K</h2>
            <small>Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis laboriosam dolore eaque inventore maiores voluptatibus, nobis cupiditate adipisci.
            </small>
        </div>
        <hr>
